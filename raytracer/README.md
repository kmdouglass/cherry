...
Test data for the feature must be generated using [refractiveindex.info-adapters](https://github.com/kmdouglass/refractiveindex.info-adapters) in bitcode format. The resulting file should be placed in the `tests/data/rii.db` directory.

## Development

### Testing

Run all tests. See [the Features section](#features) for obtaining test data.
