...
///   10,000 mm. At this scale, 1e-9 = ~550 ULPs in 64-bit floating point arithmetic.
/// - When specified in meters, we can expect distances up to a maximum of 10 m. At
///   this scale, 1e-9 = ~550,000 ULPs.
...
/// about 10,000 mm, a tolerance of 1e-9 is still 6 orders of magnitude smaller than
/// the smallest possible feature size, and affords a margin of 550 ULPs for rounding
/// errors.
